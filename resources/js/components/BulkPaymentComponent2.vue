...
export default {
    ...
    methods: {
        backURL: function () {
          return BASE_URL+ '/seller/users';
        },
        fetchData: function (user_packages) {
            loading();
            let url = BASE_URL + '/seller/payments/bulk-payment-data';
            const data = {
        ...
        payNow: function () {
            const self = this;
            loading();
            let url = BASE_URL + '/seller/payments/bulk-payment-process';
            const data = {
