...
<div class="container" style="max-width:420px">
    ...
    <div class="text-center mt-2">
        <button class="btn btn-sm btn-outline-secondary" id="theme-toggle">
            <i class="fa-solid fa-moon" id="theme-icon"></i> Toggle dark mode
        </button>
    </div>
</div>
...
<script>
    ...
    function applyTheme(t) { html.setAttribute('data-bs-theme', t); icon.className = t === 'dark' ? 'fa-solid fa-sun' : 'fa-solid fa-moon'; }
    applyTheme(localStorage.getItem('cp_theme') || 'light');
    document.getElementById('theme-toggle').addEventListener('click', function () {
        const next = html.getAttribute('data-bs-theme') === 'dark' ? 'light' : 'dark';
        localStorage.setItem('cp_theme', next); applyTheme(next);
    });
</script>
</body>
</html>
