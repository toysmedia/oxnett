...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <!-- /Logo -->
            <h5 class="mb-6 text-center"><i class='bx bx-log-in' style="vertical-align: text-top;"></i> User Login</h5>
            ...
            <form id="formAuthentication" class="mb-3" action="{{ route('login') }}" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('login') is-invalid @enderror" id="login" name="login" placeholder="mobile/username/email address" autofocus="" value="{{ old('login') }}" autocomplete="off">
                    @error('login')
