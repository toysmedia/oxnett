...
@section('title', 'PPPoE Subscribers')
    ...
    <div class="col-sm-12 mb-3">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('admin.isp.subscribers.create') }}" class="btn btn-primary">
                <i class="bx bx-plus me-1"></i> Add PPPoE Subscriber
            </a>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.isp.subscribers.pppoe') }}" class="btn btn-sm btn-outline-secondary ms-2">Clear</a>
                </div>
            </div>
            <div class="card-body pb-2">
                <form id="filterForm" method="GET" action="{{ route('admin.isp.subscribers.pppoe') }}">
                    <div class="row">
        ...
        <form id="bulkForm" action="{{ route('admin.isp.subscribers.bulk') }}" method="POST">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="ms-auto">
                        <span class="badge bg-label-primary me-2">PPPoE</span>
                    ...
                    <div class="table-responsive text-nowrap">
                        <table class="table table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        @if($subscriber->latitude && $subscriber->longitude)
                                            <small class="text-muted">
                                                ...
                                                {{ number_format($subscriber->latitude, 4) }},
                                                {{ number_format($subscriber->longitude, 4) }}
                                            </small>
                                        @else
                                            <span class="text-muted">-</span>
                                        @endif
                                ...
                                @empty
                                <tr>
                                    <td colspan="10" class="text-center py-4 text-muted">No PPPoE subscribers found.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
