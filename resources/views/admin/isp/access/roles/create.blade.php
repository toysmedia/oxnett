...
<div class="row">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.isp.access.roles.store') }}" method="POST">
                    @csrf
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" name="display_name" class="form-control" value="{{ old('display_name') }}" placeholder="e.g. Manager" required>
                        </div>
                        <div class="col-md-4">
